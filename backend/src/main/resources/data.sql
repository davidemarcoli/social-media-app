...
-- ROLES
insert into "dailylink"."roles" ("id", "name")
values ('1a7284ce-f00a-42a4-ae6a-06fcdceaf1f1', 'ROLE_ADMIN');
insert into "dailylink"."roles" ("id", "name")
values ('64dd57f6-89b1-4c8a-82e8-fe523b073201', 'ROLE_MODERATOR');
insert into "dailylink"."roles" ("id", "name")
values ('95274c56-91ec-47c2-b1f5-cb78ed8610c5', 'ROLE_USER');
...
values ('95274c56-91ec-47c2-b1f5-cb78ed8610c5', 'a7fc1f5c-86eb-4693-b959-09266acbc6ca');
insert into "dailylink"."user_roles" ("role_id", "user_id")
values ('95274c56-91ec-47c2-b1f5-cb78ed8610c5', '04b11c30-ecbf-46ca-a855-9aeec60906f5');
insert into "dailylink"."user_roles" ("role_id", "user_id")
values ('95274c56-91ec-47c2-b1f5-cb78ed8610c5', 'df3d54b5-51ed-47e2-80f6-df3567990392');
insert into "dailylink"."user_roles" ("role_id", "user_id")
values ('64dd57f6-89b1-4c8a-82e8-fe523b073201', '04b11c30-ecbf-46ca-a855-9aeec60906f5');
insert into "dailylink"."user_roles" ("role_id", "user_id")
values ('64dd57f6-89b1-4c8a-82e8-fe523b073201', 'df3d54b5-51ed-47e2-80f6-df3567990392');
insert into "dailylink"."user_roles" ("role_id", "user_id")
values ('1a7284ce-f00a-42a4-ae6a-06fcdceaf1f1', 'df3d54b5-51ed-47e2-80f6-df3567990392');

-- POSTS
insert into "dailylink"."post" ("author_id", "content", "created_at", "id", "media", "updated_at")
values ('a7fc1f5c-86eb-4693-b959-09266acbc6ca',
        ...
        '2020-06-22 19:10:25', '66f8f600-4e9b-4bc3-a1f3-cf99873158d6', NULL, NULL);
insert into "dailylink"."post" ("author_id", "content", "created_at", "id", "media", "updated_at")
values ('a7fc1f5c-86eb-4693-b959-09266acbc6ca',
        'A short poem may be a stylistic choice or it may be that you have said what you intended to say in a more concise way. Either way, they differ stylistically from a long poem in that there tends to be more care in word choice. Since there are fewer words people tend to spend more time on choosing a word that fits the subject to perfection. Because of this meticulous attitude, writing a short poem is often more tedious than writing a long poem. #longPoem #cool',
        '2020-06-22 19:10:25', 'db5cab74-3938-49df-8e88-97c5b12fe0f7', NULL, NULL);
